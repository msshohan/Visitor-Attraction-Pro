...
<a href="<?php if( get_field( "ms_notification_link_page", $ms_notification_atts["id"] ) ) {
    	...
    	?>" class="ms-notification ms-notification-container-two">

	<div class="ms-notification-style-two notification_box_wrap">
	    <div class="left_area">
	    ...
	    <div class="right_area">
	        ...
	        <div class="domain_name"><?php bloginfo( 'url' ); ?></div>
	    </div>
